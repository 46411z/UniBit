...
namespace PP_46411z
{
    class Program
    {
        ...
        {
            System.Console.WriteLine("Enter galaxy, star, planet, moon or exit:");
                ...
                if (command == "add")
                {
                    ...
                    switch (obj)
                    {
                        ...
                        case "star":
                            ...
                            double weight = double.Parse(inputText.Split(" ")[inputText.Split(" ").Length - 4].Trim(),CultureInfo.InvariantCulture);
                            double size = double.Parse(inputText.Split(" ")[inputText.Split(" ").Length - 3].Trim(),CultureInfo.InvariantCulture);
                            int temperature = int.Parse(inputText.Split(" ")[inputText.Split(" ").Length - 2].Trim());
                            double light = double.Parse(inputText.Split(" ")[inputText.Split(" ").Length - 1].Trim(),CultureInfo.InvariantCulture);
                            string clas = "";
